        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-8 mb-16">
          ...
          <div className="md:col-span-4 lg:col-span-4">
            ...
            <ul className="space-y-4">
              ...
              <li>
                <a href="https://x.com/tskrofficial" target="_blank" className="group flex items-center gap-2.5 text-white/30 hover:text-white transition-colors text-sm">
              ...
              <li>
                <a href="https://tsrkai.gitbook.io/tsrkai-docs" className="group flex items-center gap-2.5 text-white/30 hover:text-[#22D3EE] transition-colors text-sm">
